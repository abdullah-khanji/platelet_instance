...
def create_yaml(input_json_path, output_yaml_path, train_path, test_path, val_path=None):
...
if __name__ == "__main__":
    ...
    convert_to_yolo(
        ...
        input_json_path=os.path.join(base_input_path, "test.json"),
    ...
    convert_to_yolo(
        ...
        input_json_path=os.path.join(base_input_path, "train.json"),
    ...
    create_yaml(
        ...
        # val_path="data/valid/images",# or None if not applicable
